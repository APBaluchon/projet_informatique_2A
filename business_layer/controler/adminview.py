...
class AdminView(View):
    ...
    def ask_action(self):
        ...
        str
            The chosen action.
        """
        return super().get_list_input("Choose an action: ",
                                      AdminView().actions_dict.values())
    ...
    def ask_tier_to_add(self):
        ...
        str
            The chosen rank.
        """
        return super().get_list_input("Choose the rank: ",
                                      AdminView().tier_dict.values())
    ...
    def ask_division_to_add(self):
        ...
        str
            The chosen division.
        """
        return super().get_list_input("Choose the division: ",
                                      AdminView().division_dict.values())
    ...
    def ask_choice(self):
        ...
        str
            The chosen action.
        """
        return super().get_list_input("Select an action: ",
                                      AdminView().choix_dict.values())
